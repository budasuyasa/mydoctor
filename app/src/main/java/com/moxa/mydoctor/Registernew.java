...
import com.moxa.utils.CommonUtilities;
import com.moxa.utils.WakeLocker;
import com.moxa.utils.logingetset;
...
import static com.moxa.mydoctor.Home.TF_ralewayRegular;
...
//        GCMRegistrar.register(Registernew.this, CommonUtilities.SENDER_ID);
    ...
    private void postdata() {
        ...
        HttpEntity entity = MultipartEntityBuilder.create().setMode(HttpMultipartMode.BROWSER_COMPATIBLE)
                .setBoundary(boundary).addTextBody("email", email,ContentType.create("text/plain", MIME.UTF8_CHARSET)).addTextBody("username", uname, ContentType.create("text/plain", MIME.UTF8_CHARSET))
                .addTextBody("password", pwd,ContentType.create("text/plain", MIME.UTF8_CHARSET)).addBinaryBody("file", new File(picturepath),
        ...
        try {
            ...
            if (status.equals("Failed")) {
                ...
                for (int i = 0; i < j.length(); i++) {
                    ...
                    String imageUrl = getString(R.string.linkimage)+j.getString("image");
