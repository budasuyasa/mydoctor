...
import static com.moxa.mydoctor.Home.TF_opensansRegular;
...
//                getProfileInformation();
    ...
    private void getdetailforNearMe() {
        ...
        try {
            ...
            String value = new String(pwd.getBytes("UTF-8"));


            switch (click) {
                case "signin":
                    hp = new URL(getString(R.string.link) + "userlogin.php?username=" + email + "&password=" + value);
                    break;
                case "fb":
